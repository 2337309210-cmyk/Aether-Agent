...
def print_welcome() -> None:
    title = Text("Aether Agent", style="bold #f6c177")
    subtitle = Text("Evolvable Coding Agent CLI", style="bold cyan")
    cookie = Text(COOKIE_AETHER, style="bold #d19a66")
    ...
    console.print(Panel(
        body,
        title="[bold #f6c177] aether cookie ready [/bold #f6c177]",
...
def print_user_prompt() -> None:
    console.print("\n[bold #f6c177]Aether[/bold #f6c177] [bold cyan]Agent[/bold cyan] [dim]❯[/dim] ", end="")
...
def print_goodbye() -> None:
    console.print(Panel(
        Text("Bye. Aether cookie saved for next time.", style="bold #f6c177"),
        border_style="#d19a66",
        box=box.ROUNDED,
        padding=(0, 1),
    ))
