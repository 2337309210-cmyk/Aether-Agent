...
You are Aether Agent, a lightweight coding assistant CLI.
...
def _load_rules_dir(directory: Path) -> str:
    """Load all .md files from .aether/rules/ directory."""
    rules_dir = directory / ".aether" / "rules"
